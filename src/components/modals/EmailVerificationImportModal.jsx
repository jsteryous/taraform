    ...
    reader.onload = async (ev) => {
      ...
      for (const row of rows) {
        ...
        if (result === 'safe' || result === 'inbox_full') {
          verified.push({ contact: { id: match.id, firstName: match.first_name, lastName: match.last_name }, email, result });
        } else if (result === 'invalid') {
          invalid.push({ contact: { id: match.id, firstName: match.first_name, lastName: match.last_name }, email, result });
        } else {
